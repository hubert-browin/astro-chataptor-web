...
const pl: ShoperIntegrationTranslations = {
  ...
  howItWorks: {
    ...
    title: 'Jak to działa',
    subtitle: 'Od instalacji w Shoper App Store do pierwszej rozmowy w dosłownie kilka kliknięć.',
    steps: [
      {
  ...
  widgetPreview: {
    ...
    subtitle: 'Widget płynnie wpasowuje się w każdy szablon Shoper i wygląda profesjonalnie.',
    ...
    items: [
      {
        ...
        answer:
          'Oferujemy trzy plany: Free (0 zł, 100 wiadomości/mies., 1 agent), Pro (199 zł/mies., 5 000 wiadomości, 10 agentów, tłumaczenia AI) oraz Enterprise (799 zł/mies., 50 000 wiadomości, bez limitu agentów, AI, wszystkie kanały). Wszyscy nowi użytkownicy otrzymują pierwsze 3 miesiące planu Pro gratis.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Tak. W planach Pro i Enterprise dostępne są tłumaczenia AI w czasie rzeczywistym (DeepL i OpenAI) — ponad 30 języków. Klient pisze w swoim języku, Ty odpowiadasz w swoim, Chataptor tłumaczy automatycznie.',
      },
    ],
  },
  cta: {
    ...
    subtitle:
      'Zainstaluj Chataptor w swoim sklepie Shoper w 2 minuty. Pierwsze 3 miesiące planu Pro gratis.',
    primaryCTA: 'Zainstaluj w Shoper App Store',
    secondaryCTA: 'Utwórz konto Chataptor',
  },
};
...
const en: ShoperIntegrationTranslations = {
  meta: {
    ...
    description:
      'Add a modern live chat widget to your Shoper store. Automatic customer identification, agent dashboard, AI translations. First 3 months free.',
  },
  hero: {
    badge: 'Shoper App Store',
    platformBadge: 'Shoper',
  ...
  features: {
    ...
    subtitle: 'One widget, a complete toolkit to talk with visitors of your Shoper store.',
    items: [
      {
        icon: '🎨',
  ...
  howItWorks: {
    ...
    title: 'How it works',
    subtitle: 'From Shoper App Store install to first conversation in just a few clicks.',
    steps: [
      {
  ...
  widgetPreview: {
    ...
    subtitle: 'The widget fits seamlessly into any Shoper theme and always looks professional.',
    ...
    items: [
      {
        ...
        answer:
          'We offer three plans: Free (0 PLN, 100 messages/month, 1 agent), Pro (199 PLN/month, 5,000 messages, 10 agents, AI translations) and Enterprise (799 PLN/month, 50,000 messages, unlimited agents, AI, all channels). All new users get the first 3 months of the Pro plan free of charge.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Yes. Pro and Enterprise plans include real-time AI translations (DeepL and OpenAI) — more than 30 languages. Customers write in their language, you reply in yours, Chataptor translates automatically.',
      },
    ],
  },
  cta: {
    ...
    subtitle:
      'Install Chataptor on your Shoper store in 2 minutes. First 3 months of the Pro plan free.',
    primaryCTA: 'Install from Shoper App Store',
    secondaryCTA: 'Create Chataptor account',
  },
};
...
export function getShoperIntegration(lang: Locale): ShoperIntegrationTranslations {
