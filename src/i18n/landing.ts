...
export const landing: Record<Locale, LandingTranslations> = {
  ...
  pl: {
    ...
    hero: {
      badge: 'Nowość: Omnichannel w jednym panelu!',
      badgeMobile: 'Mail, IG, FB i WhatsApp w jednym panelu!',
  ...
  en: {
    ...
    hero: {
      badge: 'New: Omnichannel in one inbox!',
      badgeMobile: 'Email, IG, FB and WhatsApp in one inbox!',
  ...
  de: {
    ...
    hero: {
      badge: 'Neu: Omnichannel in einem Posteingang!',
      badgeMobile: 'E-Mail, IG, FB und WhatsApp in einem Posteingang!',
  ...
  fr: {
    ...
    hero: {
      badge: 'Nouveau : omnicanal dans une boîte unique !',
      badgeMobile: 'E-mail, IG, FB et WhatsApp dans une boîte unique !',
  ...
  es: {
    ...
    hero: {
      badge: 'Nuevo: omnicanal en una bandeja!',
      badgeMobile: 'Email, IG, FB y WhatsApp en una bandeja!',
  ...
  it: {
    ...
    hero: {
      badge: 'Novità: omnichannel in un\'unica inbox!',
      badgeMobile: 'Email, IG, FB e WhatsApp in un\'unica inbox!',
  ...
  cs: {
    ...
    hero: {
      badge: 'Novinka: omnichannel v jedné schránce!',
      badgeMobile: 'E-mail, IG, FB a WhatsApp v jedné schránce!',
  ...
  sk: {
    ...
    hero: {
      badge: 'Novinka: omnichannel v jednej schránke!',
      badgeMobile: 'E-mail, IG, FB a WhatsApp v jednej schránke!',
