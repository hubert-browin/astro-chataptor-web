...
export const landing: Record<Locale, LandingTranslations> = {
  ...
  pl: {
    ...
    hero: {
      ...
      badgeMobile: 'Nowość: wszystkie kanały komunikacji w jednym miejscu!',
  ...
  de: {
    ...
    hero: {
      ...
      badgeMobile: 'Neu: alle Kommunikationskanäle an einem Ort!',
  ...
  fr: {
    ...
    hero: {
      ...
      badgeMobile: 'Nouveau : tous les canaux de communication en un seul endroit!',
  ...
  es: {
    ...
    hero: {
      ...
      badgeMobile: 'Nuevo: todos los canales de comunicación en un solo lugar!',
  ...
  it: {
    ...
    hero: {
      ...
      badgeMobile: 'Novità: tutti i canali di comunicazione in un unico posto!',
  ...
  cs: {
    ...
    hero: {
      ...
      badgeMobile: 'Novinka: všechny komunikační kanály na jednom místě!',
  ...
  sk: {
    ...
    hero: {
      ...
      badgeMobile: 'Novinka: všetky komunikačné kanály na jednom mieste!',
