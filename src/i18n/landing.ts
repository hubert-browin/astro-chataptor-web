...
export const landing: Record<Locale, LandingTranslations> = {
  pl: {
    ...
    hero: {
      ...
      description: 'Przełam barierę językową. Czatuj z tłumaczeniami AI na żywo.',
      descriptionMobile: 'Przełam barierę językową. Czatuj z tłumaczeniami AI na żywo.',
      descriptionHighlight: 'Zero tłumaczy. Zero opóźnień. Ponad 100 języków.',
  ...
  en: {
    ...
    hero: {
      ...
      title2: 'in any language worldwide.',
      description: 'Break the language barrier. Chat with live AI translations.',
      descriptionMobile: 'Break the language barrier. Chat with live AI translations.',
      descriptionHighlight: 'Zero translators. Zero delays. Over 100 languages.',
      cta: 'Join the beta',
      demo: 'Contact us',
  ...
  de: {
    ...
    hero: {
      ...
      description: 'Überwinden Sie die Sprachbarriere. Chatten Sie mit Live-KI-Übersetzungen.',
      descriptionMobile: 'Überwinden Sie die Sprachbarriere. Chatten Sie mit Live-KI-Übersetzungen.',
      descriptionHighlight: 'Keine Übersetzer. Keine Verzögerungen. Über 100 Sprachen.',
      cta: 'Beta beitreten',
  ...
  fr: {
    ...
    hero: {
      ...
      title2: 'dans toutes les langues du monde.',
      description: 'Brisez la barrière de la langue. Tchatez avec des traductions IA en direct.',
      descriptionMobile: 'Brisez la barrière de la langue. Tchatez avec des traductions IA en direct.',
      descriptionHighlight: 'Zéro traducteur. Zéro délai. Plus de 100 langues.',
  ...
  es: {
    ...
    hero: {
      ...
      title2: 'en cualquier idioma del mundo.',
      description: 'Rompe la barrera del idioma. Chatea con traducciones de IA en vivo.',
      descriptionMobile: 'Rompe la barrera del idioma. Chatea con traducciones de IA en vivo.',
      descriptionHighlight: 'Cero traductores. Cero retrasos. Más de 100 idiomas.',
  ...
  it: {
    ...
    hero: {
      ...
      title2: 'in qualsiasi lingua del mondo.',
      description: 'Supera la barriera linguistica. Chatta con traduzioni IA dal vivo.',
      descriptionMobile: 'Supera la barriera linguistica. Chatta con traduzioni IA dal vivo.',
      descriptionHighlight: 'Zero traduttori. Zero ritardi. Oltre 100 lingue.',
  ...
  cs: {
    ...
    hero: {
      ...
      title2: 'v jakémkoli jazyce světa.',
      description: 'Prolomte jazykovou bariéru. Chatujte s živými AI překlady.',
      descriptionMobile: 'Prolomte jazykovou bariéru. Chatujte s živými AI překlady.',
      descriptionHighlight: 'Žádní překladatelé. Žádná zpoždění. Více než 100 jazyků.',
  ...
  sk: {
    ...
    hero: {
      ...
      title2: 'v každom jazyku sveta.',
      description: 'Prelomte jazykovú bariéru. Chatujte so živými AI prekladmi.',
      descriptionMobile: 'Prelomte jazykovú bariéru. Chatujte so živými AI prekladmi.',
      descriptionHighlight: 'Žiadni prekladatelia. Žiadne meškania. Viac ako 100 jazykov.',
    ...
    implementation: {
      ...
      step2: { title: 'Vložte do <head>', description: 'Funguje s akýmkoľvek CMS a vlastním obchodom.' },
