...
export const about: Record<Locale, AboutTranslations> = {
  pl: {
    ...
    team: {
      ...
      marek: {
        role: 'Magik od kodu i biznesu',
        bio: 'Mózg operacyjny i architekt całej naszej technologii. Programista, który przez lata hartował się w rygorystycznej branży bankowej (gdzie nie ma miejsca na błędy ani opóźnienia), a potem przeniósł tę niezawodność do świata produktów biznesowych. Marek to prawdziwy specjalista od wykorzystywania IT do zwiększania sprzedaży. Udowodnił, że niemożliwe nie istnieje - z pomocą sztucznej inteligencji, w zaledwie rok napisał całego Chataptora od zera. Nasz system działa błyskawicznie i to właśnie jego zasługa.',
      },
    },
    philosophy: {
      ...
      p3: 'Naszym celem jest zburzenie granic. Chcemy, aby każda firma - niezależnie od tego, czy jest to lokalny software house, hotel, firma usługowa czy rosnąca marka - mogła uruchomić sprzedaż na nowym rynku dosłownie z dnia na dzień.',
      p4: 'Dajemy Ci narzędzie do globalnej ekspansji, które jest proste, darmowe i po prostu działa.',
    },
    cta: {
      title: 'Gotowy na usunięcie barier?',
      desc: 'Nie potrzebujesz kolejnego skomplikowanego systemu. Załóż darmowe konto, wklej jeden kod na stronę i zacznij działać globalnie.',
    },
  },
  en: {
    hero: {
    ...
    team: {
      ...
      marek: {
        role: 'Code and Business Wizard',
        bio: 'The operational brain and architect of our entire technology. A programmer who hardened himself for years in the rigorous banking industry (where there is no room for errors or delays), and then transferred this reliability to business products. Marek is a true specialist in using IT to increase sales. He proved that the impossible does not exist - with the help of artificial intelligence, he wrote the entire Chataptor from scratch in just a year. Our system works instantly and that is his merit.',
      },
    },
    philosophy: {
      ...
      p3: 'Our goal is to tear down borders. We want every company - whether it\'s a local software house, a hotel, a service company, or a growing brand - to be able to launch sales in a new market literally overnight.',
      p4: 'We give you a tool for global expansion that is simple, free, and simply works.',
    },
    cta: {
      title: 'Ready to remove barriers?',
      desc: 'You don\'t need another complicated system. Create a free account, paste one code on the page and start operating globally.',
    },
  },
  de: {
    hero: {
    ...
    team: {
      ...
      desc: 'Wir sind kein riesiges Unternehmen mit einer Armee von Kapitalgebern in Anzügen. Wir sind ein Zwei-Mann-Team, das beschlossen hat zu beweisen, dass man Marktriesen herausfordern kann, indem man ein intelligenteres und clevereres Produkt schafft.',
      hubert: {
    ...
    philosophy: {
      ...
      p3: 'Unser Ziel ist es, Grenzen niederzureißen. Wir wollen, dass jedes Unternehmen - ob lokales Softwarehaus, Hotel, Dienstleistungsunternehmen oder wachsende Marke - den Verkauf auf einem neuen Markt buchstäblich über Nacht starten kann.',
      p4: 'Wir geben Ihnen ein Werkzeug für die globale Expansion, das einfach, kostenlos ist und zuverlässig funktioniert.',
    },
    cta: {
      title: 'Bereit, Barrieren zu beseitigen?',
      desc: 'Sie brauchen kein weiteres kompliziertes System. Erstellen Sie ein kostenloses Konto, fügen Sie einen Code auf der Seite ein und beginnen Sie global zu operieren.',
    },
  },
  fr: {
    hero: {
    ...
    philosophy: {
      ...
      p3: 'Notre objectif est d\'abattre les frontières. Nous voulons que chaque entreprise - qu\'il s\'agisse d\'une société de logiciels locale, d\'un hôtel, d\'une entreprise de services ou d\'une marque en croissance - puisse lancer des ventes sur un nouveau marché littéralement du jour au lendemain.',
      p4: 'Nous vous donnons un outil pour l\'expansion mondiale qui est simple, gratuit et qui fonctionne simplement.',
    },
    cta: {
      title: 'Prêt à supprimer les barrières ?',
      desc: 'Vous n\'avez pas besoin d\'un autre système compliqué. Créez un compte gratuit, collez un code sur la page et commencez à opérer mondialement.',
    },
  },
  es: {
    hero: {
    ...
    team: {
      ...
      marek: {
        role: 'Mago del código y el negocio',
        bio: 'El cerebro operativo y arquitecto de toda nuestra tecnología. Un programador que se endureció durante años en la rigurosa industria bancaria (donde no hay lugar para errores o retrasos), y luego transfirió esta fiabilidad a productos de negocio. Marek es un verdadero especialista en el uso de TI para aumentar las ventas. Demostró que lo imposible no existe: con la ayuda de la inteligencia artificial, escribió todo Chataptor desde cero en solo un año. Nuestro sistema funciona al instante y ese es su mérito.',
      },
    },
    philosophy: {
      ...
      p3: 'Nuestro objetivo es derribar fronteras. Queremos que cada empresa, ya sea una empresa de software local, un hotel, una empresa de servicios o una marca en crecimiento, pueda lanzar ventas en un nuevo mercado literalmente de la noche a la mañana.',
      p4: 'Te damos una herramienta para la expansión global que es simple, gratuita y simplemente funciona.',
    },
    cta: {
      title: '¿Listo para eliminar barreras?',
      desc: 'No necesitas otro sistema complicado. Crea una cuenta gratis, pega un código en la página y comienza a operar globalmente.',
    },
  },
  it: {
    hero: {
    ...
    team: {
      ...
      marek: {
        role: 'Mago del codice e del business',
        bio: 'Il cervello operativo e l\'architetto di tutta la nostra tecnologia. Un programmatore che si è temprato per anni nel rigoroso settore bancario (dove non c\'è spazio per errori o ritardi), e poi ha trasferito questa affidabilità ai prodotti business. Marek è un vero specialista nell\'uso dell\'IT per aumentare le vendite. Ha dimostrato che l\'impossibile non esiste: con l\'aiuto dell\'intelligenza artificiale, ha scritto l\'intero Chataptor da zero in un solo anno. Il nostro sistema funziona all\'istante e questo è merito suo.',
      },
    },
    philosophy: {
      ...
      p3: 'Il nostro obiettivo è abbattere i confini. Vogliamo che ogni azienda - che si tratti di una software house locale, un hotel, un\'azienda di servizi o un brand in crescita - possa lanciare le vendite in un nuovo mercato letteralmente da un giorno all\'altro.',
      p4: 'Ti diamo uno strumento per l\'espansione globale che è semplice, gratuito e funziona semplicemente.',
    },
    cta: {
      title: 'Pronto a rimuovere le barriere?',
      desc: 'Non hai bisogno di un altro sistema complicato. Crea un account gratuito, incolla un codice sulla pagina e inizia a operare a livello globale.',
    },
  },
  cs: {
    hero: {
    ...
    philosophy: {
      ...
      p3: 'Naším cílem je bořit hranice. Chceme, aby každá firma - ať už je to lokální softwarový dům, hotel, službová firma nebo rostoucí značka - mohla spustit prodej na novém trhu doslova přes noc.',
      p4: 'Dáváme vám nástroj pro globální expanzi, který je jednoduchý, zdarma a prostě funguje.',
    },
    cta: {
      title: 'Jste připraveni odstranit bariéry?',
      desc: 'Nepotřebujete další složitý systém. Vytvořte si bezplatný účet, vložte jeden kód na stránku a začněte fungovat globálně.',
    },
  },
  sk: {
    hero: {
    ...
    team: {
      ...
      marek: {
        role: 'Čarodejník kódu a biznisu',
        bio: 'Operačný mozog a architekt celej našej technológie. Programátor, ktorý sa roky zoceloval v prísnom bankovom sektore (kde nie je priestor pre chyby alebo oneskorenia), a potom túto spoľahlivosť preniesol do biznisových produktov. Marek je skutočný špecialista na využívanie IT na zvýšenie predaja. Dokázal, že nemožné neexistuje - s pomocou umelej inteligencie napísal celý Chataptor od nuly za jediný rok. Náš systém funguje okamžite a to je jeho zásluha.',
      },
    },
    philosophy: {
      ...
      p3: 'Naším cieľom je búrať hranice. Chceme, aby každá firma - či už je to lokálny softvérový dom, hotel, firma služieb alebo rastúca značka - mohla spustiť predaj na novom trhu doslova cez noc.',
      p4: 'Dávame vám nástroj pre globálnu expanziu, ktorý je jednoduchý, bezplatný a jednoducho funguje.',
    },
    cta: {
      title: 'Ste pripravení odstrániť bariéry?',
      desc: 'Nepotrebujete ďalší zložitý systém. Vytvorte si bezplatný účet, vložte jeden kód na stránku a začnite fungovať globálne.',
    },
  },
};
