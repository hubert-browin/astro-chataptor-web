---
title: "Připravené odpovědi pro live chat: 30 šablon pro zákaznickou podporu"
description: "Použijte 30 připravených odpovědí pro live chat: dostupnost, doprava, vrácení, reklamace, nabídky, zahraniční zákazníci a e-commerce."
lang: "cs"
...
imageAlt: "Inbox live chatu s uloženými šablonami odpovědí, rychlými příkazy a konverzací se zákazníkem"
translatedBy: "manual"
reviewed: true
sourceFile: "cs/pripravene-odpovedi-live-chat"
---
...
Pokud nástroj teprve vybíráte, podívejte se také na průvodce [live chatem zdarma bez limitu zpráv](/cs/blog/live-chat-zdarma-bez-limitu/). Pokud řešíte více kanálů, pomůže článek o tom, jak mít [zprávy od zákazníků na jednom místě](/cs/blog/zpravy-od-zakazniku-na-jednom-miste/).
...
Více v článku o [automatickém překladu v zákaznickém servisu](/cs/blog/automaticky-preklad-zakaznicky-servis/).
...
V Chataptoru můžete vytvářet šablony, řešit více kanálů v jednom inboxu a podporovat zákazníky v různých jazycích. Můžete [začít používat Chataptor zdarma](/cs/).
